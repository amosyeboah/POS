...
function modifyQueryString($overrides = []) {
    ...
    return 'sales_report.php' . ($query ? ('?' . $query) : '');
}
?>
...
<body>
    <div class="container">
        <div class="header">
            <a href="dashboard.php" class="btn btn-outline" id="back-arrow" style="display:inline-flex;align-items:center;gap:0.5rem;">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form id="filters-form" method="GET" action="sales_report.php">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('reset-filters').addEventListener('click', function(e) {
                e.preventDefault();
                window.location.href = 'sales_report.php?page=1';
            });
